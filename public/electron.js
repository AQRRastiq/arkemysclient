...
if (!app.isDefaultProtocolClient('arkemysclient')) {
  app.setAsDefaultProtocolClient('arkemysclient');
}
...
app.setPath('userData', path.join(app.getPath('appData'), 'arkemysclient_next'));
...
function createWindow() {
  ...
  mainWindow.webContents.session.webRequest.onBeforeSendHeaders(
    (details, callback) => {
      ...
      if (xSkipOrigin !== 'skip') {
        requestHeaders.Origin = 'https://github.com/AQRRastiq/arkemysclient';
      }
  ...
  tray.setToolTip('Arkemys Client');
