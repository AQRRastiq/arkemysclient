...
const ModOverview = ({
  ...
  const getPlaceholderText = () => {
    if (loadingFiles) {
      ...
      return 'Mod non disponible';
    } else {
      return 'Selectionner une version';
    }
  };
          ...
          {installedData.fileID &&
            ...
            !files.find(v => v.id === installedData.fileID) && (
              <div
                ...
                `}
              >
                La version installée de ce mod n'est plus trouvable sur CurseForge donc il sera installé qu'en tant que modpack.
              </div>
            )}
          <StyledSelect
