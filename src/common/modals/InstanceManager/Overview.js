    ...
    <Container>
      <Column>
        ...
        >
          ...
          <Card
            title="Date du dernier lancement"
        ...
        <OverviewCard>
          <JavaManagerRow>
            <div>Changer la résolution du jeu</div>
            <Switch
          ...
          <JavaManagerRow>
            <div>Changer la mémoire Java</div>
            <Switch
          ...
          <JavaManagerRow>
            <div>Changer les arguments Java</div>
            <Switch
          ...
          <JavaManagerRow>
            <div>Customiser le chemin vers Java</div>
            <Switch
